...
var dimLines;
	...
	function inicializarDimCtrl (vehSelect) { 
		...
		for (var i = 0; i < imgComposite[vehSelect].length; i++) {
			...
			imagen.style = "border: none; padding: 0; margin: 0; position: absolute; left: " + posLeft + "px; height: 400px; display: " + imgComposite[vehSelect][i][2] + ";";
		...
		for (var i = 1; i < tablaPesos.length; i++) {		
			...
			for (var g = 1; g < 3; g++) {
				...
				if (tablaPesos[i][2] == "select") {
					inputBox.style = "width: 100%; padding-top: 2px; padding-bottom: 2px; margin-bottom: 5px";
					...
					inputBox.style = "float: left; text-align: right; width: 70%; padding-top: 2px; padding-bottom: 1px;margin-bottom: 5px";
				}
